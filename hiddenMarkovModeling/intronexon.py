...
states = ('intron', 'exon')
start_p = {'intron': initproblist2[0], 'exon': initproblist2[1]}
trans_p = {
   'intron' : {'intron': transproblist2[0], 'exon': transproblist2[1]},
   'exon' : {'intron': transproblist2[2], 'exon': transproblist2[3]}
   }
emit_p = {
   'intron' : {'A': emisproblist2[0], 'T': emisproblist2[1], 'G': emisproblist2[2],'C':emisproblist2[3]},
   'exon' : {'A': emisproblist2[4], 'T': emisproblist2[5], 'G': emisproblist2[6],'C':emisproblist2[7]}
   }
#print trans_p
#print emit_p
